...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'fcm-device-token-123456' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], RegisterDeviceDto.prototype, "fcmToken", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['android', 'ios'], example: 'android' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsIn)(['android', 'ios'], { message: 'Platform must be either android or ios.' }),
    __metadata("design:type", String)
